...
urlpatterns = [
    ...
    path(
        "purchases/<int:pk>/certificate/",
        PurchaseCertificateView.as_view(),
        name="purchase-certificate",
    ),
    path(
        "purchases/<int:pk>/receipt/",
        PurchaseReceiptView.as_view(),
    ...
    path(
        "provider/payouts/",
        ProviderPayoutListView.as_view(),
        name="provider-payout-list",
    ),
]
